...
This is the core foundation of the `@nestjs-adapters/core` library. The decorator-driven adapter API provides a clean, declarative way to build NestJS dynamic modules that implement the Ports & Adapters (Hexagonal Architecture) pattern.
